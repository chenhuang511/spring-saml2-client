...
public class SamlClient {
    ...
    public String getSamlRequest() throws SamlException {
        ...
        this.requestId = "z" + UUID.randomUUID().toString();
        request.setID(this.requestId); // ADFS needs IDs to start with a letter
    ...
    public SamlResponse validateSamlResponse(Response response) throws SamlException {
        validateResponse(response);
        validateAssertion(response);
        validateSignature(response);
